...
const DEFAULT_TITLE = 'PhimFlix4K Phim & Phim Bộ Thịnh Hành: Nội Dung, Đánh Giá, Diễn Viên & Trailer Đầy Đủ';
const DEFAULT_DESC = 'PhimFlix4K cung cấp nội dung phim, diễn viên, đánh giá và trailer chính thức của những phim và phim bộ phổ biến nhất hiện nay, kèm thông tin đầy đủ về mùa và tập phim.';
